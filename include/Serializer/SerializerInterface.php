...
interface SerializerInterface {
  ...
  /**
   * The serializer format group name.
   *
   * @var string
   */
  const FORMAT_GROUP = 'srz';
   ...
   *
   * @return bool|string
   *   The serialized representation of the given collection, FALSE otherwise.
   */
  public function serialize(array $collection);

  /**
   * Get the format name of the serializer.
   *
   * @return string
   *   The format name of the serializer.
   */
