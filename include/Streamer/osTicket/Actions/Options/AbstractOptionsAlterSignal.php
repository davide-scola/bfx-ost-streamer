...
/**
 * The osTicket abstract options alter signal.
 */
abstract class AbstractOptionsAlterSignal extends OptionsAlterSignal {
  ...
  /**
   * Get the options section name.
   *
   * @return string
   *   The options section name.
   */
