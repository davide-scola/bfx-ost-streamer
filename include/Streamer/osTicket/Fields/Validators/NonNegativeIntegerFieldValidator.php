...
/**
 * The non negative integer field validator.
 */
class NonNegativeIntegerFieldValidator extends AbstractFieldValidator {

  /**
   * {@inheritDoc}
   */
  protected static function isNotValid($value) : bool {
    return NonNegativeIntegerValidator::isNotValid($value);
  }
