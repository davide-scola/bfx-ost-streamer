...
/**
 * The non negative double word field validator.
 */
class NonNegativeDoubleWordFieldValidator extends AbstractFieldValidator {

  /**
   * {@inheritDoc}
   */
  protected static function isNotValid($value) : bool {
    return NonNegativeDoubleWordValidator::isNotValid($value);
  }
