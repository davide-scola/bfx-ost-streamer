...
/**
 * The positive integer field validator.
 */
class PositiveIntegerFieldValidator extends AbstractFieldValidator {

  /**
   * {@inheritDoc}
   */
  protected static function isNotValid($value) : bool {
    return PositiveIntegerValidator::isNotValid($value);
  }
