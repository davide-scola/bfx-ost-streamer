...
/**
 * The beanstalk tube field validator.
 */
class BeanstalkTubeFieldValidator extends AbstractFieldValidator {

  /**
   * {@inheritDoc}
   */
  public static function length() : int {
    return \intval(BeanstalkTubeValidator::getMaximumLength());
  }
  ...
  protected static function error() : string {
    return __('Not a valid beanstalk tube name');
  }
  ...
  protected static function isNotValid($value) : bool {
    return BeanstalkTubeValidator::isNotValid($value);
  }
