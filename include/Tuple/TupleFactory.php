 ...
 * The tuple factory.
 */
class TupleFactory extends AbstractFactory {

  /**
   * {@inheritDoc}
   *
   * @return TupleInterface
   *   A new instance of the tuple.
   */
  public function create(string $format, ...$arguments) : TupleInterface {
  ...
  protected function options() : array {
    return [
      Sequence::getFormatName() => [
        static::DESCRIPTION_KEY => 'Sequence',
