...
/**
 * The Kinesis stream name validator.
 */
class KinesisStreamValidator extends AbstractRegularExpressionValidator {
  ...
  protected static function getSearchPattern() : string {
    return \sprintf('/^[-a-z0-9_.]{1,%d}$/i',
      static::getMaximumLength()
    );
  }
